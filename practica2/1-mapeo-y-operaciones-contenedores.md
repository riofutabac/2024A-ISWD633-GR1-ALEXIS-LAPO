...
Para listar los archivos y directorios en el sistema de archivos del contenedor
### ¿Para qué sirve el argumento -l junto al comando ls?
El argumento -l junto al comando ls muestra una lista detallada de archivos y directorios, proporcionando información adicional como permisos, número de enlaces, propietario, grupo, tamaño, y la fecha y hora de la última modificación.
...
![Imagen](imagenes/captura2-2.png)
...
```
# COLOCAR UNA CAPTURA DE PANTALLA
![Imagen](imagenes/captura3-2.png)
